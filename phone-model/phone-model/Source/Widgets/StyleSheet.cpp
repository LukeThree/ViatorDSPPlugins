...
namespace juce
{
                                                 ...
                                                 Slider& slider)
    {
        ...
        g.setColour (slider.findColour(Slider::rotarySliderFillColourId));
        g.drawLine(backgroundArc.getBounds().getCentreX(), backgroundArc.getBounds().getCentreY(), thumbPoint.getX(), thumbPoint.getY(), lineW * 0.75);
    }
...
void LV_AlphaDialLAF::drawLabel(Graphics &g, Label &label)
{
                                          ...
                                          Slider &slider)
    {
        ...
        g.setColour(juce::Colour::fromFloatRGBA(0.165, 0.165, 0.165, 1.0)); //center
        g.fillEllipse(dialArea);
        
        g.setColour(juce::Colour::fromFloatRGBA(0.831, 0.765, 0.663, 0.6)); //outline
        g.drawEllipse(rx, ry, diameter, diameter, 4.0f);
        juce::Path dialTick;
        g.setColour(juce::Colour::fromFloatRGBA(0.831, 0.765, 0.663, 0.6)); //tick color
