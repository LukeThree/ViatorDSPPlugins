...
void LV_DialComponent::initShadows()
{
    ...
    shadowProperties.offset = juce::Point<int> (0, 6);
...
void LV_DialComponent::initProps(juce::String suffix, double rangeStart, double rangeEnd, double intervalValue, double returnValue)
{
    ...
    dial.setColour(juce::Slider::ColourIds::rotarySliderFillColourId, juce::Colour::fromFloatRGBA(0.831, 0.765, 0.663, 0.8));
    dial.setColour(juce::Slider::ColourIds::rotarySliderOutlineColourId, juce::Colour::fromFloatRGBA(0.165, 0.165, 0.165, 1.0));
    dial.setColour(juce::Slider::ColourIds::textBoxOutlineColourId, juce::Colours::black.withAlpha(0.0f));
    dial.setColour(juce::Slider::ColourIds::textBoxTextColourId, juce::Colour::fromFloatRGBA(0.831, 0.765, 0.663, 0.5));
...
void LV_DialComponent::setDialSkew(float newMidPoint)
{
    dial.setSkewFactorFromMidPoint(newMidPoint);
}
