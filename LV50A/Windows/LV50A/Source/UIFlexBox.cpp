...
void LV50AAudioProcessorEditor::setFlexBox()
{
    ...
    itemArrayColumnOne.add(juce::FlexItem(bounds.getWidth() / 4, bounds.getHeight() / 4, bandOneGainSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.07f, 0, 0, bounds.getWidth() * .1)));
    itemArrayColumnOne.add(juce::FlexItem(bounds.getWidth() / 4, bounds.getHeight() / 4, bandOneFreqSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.08f, 0, 0, bounds.getWidth() * .1)));
    ...
    itemArrayColumnTwo.add(juce::FlexItem(bounds.getWidth() / 4, bounds.getHeight() / 4, bandTwoGainSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.07f, 0, 0, bounds.getWidth() * .1)));
    itemArrayColumnTwo.add(juce::FlexItem(bounds.getWidth() / 4, bounds.getHeight() / 4, bandTwoFreqSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.08f, 0, 0, bounds.getWidth() * .1)));
    ...
    itemArrayColumnThree.add(juce::FlexItem(bounds.getWidth() / 4, bounds.getHeight() / 4, bandThreeGainSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.07f, 0, 0, bounds.getWidth() * .1)));
    itemArrayColumnThree.add(juce::FlexItem(bounds.getWidth() / 4, bounds.getHeight() / 4, bandThreeFreqSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.08f, 0, 0, bounds.getWidth() * .1)));
    ...
    itemArrayColumnFour.add(juce::FlexItem(bounds.getWidth() / 4, bounds.getHeight() / 4, bandFourGainSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.07f, 0, 0, bounds.getWidth() * .1)));
    itemArrayColumnFour.add(juce::FlexItem(bounds.getWidth() / 4, bounds.getHeight() / 4, bandFourFreqSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.08f, 0, 0, bounds.getWidth() * .1)));
    ...
    itemArrayColumnFive.add(juce::FlexItem(bounds.getWidth() / 1.95, bounds.getHeight() / 2.0, driveSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.15f, 0, 0, 0)));

    flexboxColumnFive.items = itemArrayColumnFive;
    flexboxColumnFive.performLayout(bounds.removeFromLeft(bounds.getWidth() / 3));
    
    filtersToggle.setBounds(driveSlider.getX() + driveSlider.getWidth() / 4, lowShelfToggle.getY(), lowShelfToggle.getWidth(), lowShelfToggle.getHeight());
    /* ============================================================================ */
    ...
    itemArrayColumnSix.add(juce::FlexItem(bounds.getWidth() / 1.95, bounds.getHeight() / 2.0, trimSlider).withMargin(juce::FlexItem::Margin(bounds.getHeight() * 0.15f, 0, 0, bounds.getWidth() * -0.5)));
